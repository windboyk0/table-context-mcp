...
```
- 웹 UI 접근 URL: `http://localhost:8090`
...
```json
{
  "mcpServers": {
    "table-context": {
      "command": "D:\\VS-Workspace\\gemini-workspace\\table-context-mcp\\venv\\Scripts\\python.exe",
      "args": ["D:\\VS-Workspace\\gemini-workspace\\table-context-mcp\\mcp_server.py"]
    }
  }
}
```
